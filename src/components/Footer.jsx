...
const Footer = () => {
  ...
  return (
    <>
      <footer className="bg-white dark:bg-github-bg text-gray-800 dark:text-white border-t border-gray-200 dark:border-github-border transition-colors duration-300">
